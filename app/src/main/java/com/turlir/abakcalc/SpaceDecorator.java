...
public class SpaceDecorator extends RecyclerView.ItemDecoration {
     ...
     */
    SpaceDecorator(Context cnt, @DimenRes int all) {
     ...
     */
    SpaceDecorator(Context cnt, @DimenRes int side, @DimenRes int front) {
     ...
     */
    SpaceDecorator(Context cnt, @DimenRes int left, @DimenRes int top, @DimenRes int right, @DimenRes int bottom) {
     ...
     * @param bottom отступ снизу
     */
    SpaceDecorator(int left, int top, int right, int bottom) {
        mLeft = left;
        mTop = top;
        mRight = right;
        mBottom = bottom;
